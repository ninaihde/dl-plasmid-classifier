...
Simulate.Reads <- function(DeepSimDir=NULL, InputFastaFile=NULL, ReadCoverage=NULL, ReadLength=250, pairedEnd=F,
    ...
    # MeanFragmentSize should be between 300 and 800 for paired end /short-insert library simulation.
    # More than 1kb is not feasible https://www.ecseq.com/support/ngs/what-is-mate-pair-sequencing-useful-for
...
Simulate.Reads.fromMultipleGenomes <- function(Members=NULL, TotalReadNumber=NULL, Proportional2GenomeSize=T,
                                               Fix.Coverage=F, ReadLength=250, pairedEnd=F,
                                               FastaFileLocation=NULL, IMGdata=NULL, TargetDirectory=NULL,
